...
function Fun.Create(title)
    ...
    mainFrame.BackgroundColor3 = Color3.fromRGB(47, 56, 47)
    ...
    mainSide.BackgroundColor3 = Color3.fromRGB(38, 43, 36)
    ...
    nightmares.TextColor3 = Color3.fromRGB(53, 92, 52)
    ...
    cover.BackgroundColor3 = Color3.fromRGB(35, 41, 34)
    ...
    function tabHandling:Tab(tabText)
        ...
        tabButton.TextColor3 = Color3.fromRGB(87, 102, 85)
        ...
        newPage.ScrollBarImageColor3 = Color3.fromRGB(104, 148, 99)
        ...
        function sectionHandling:Section(sectionName)
            ...
            sectionFrame.BackgroundColor3 = Color3.fromRGB(39, 46, 39)
            ...
            sectionFrameHead.BackgroundColor3 = Color3.fromRGB(39, 46, 39)
            ...
            sectionCircle.BackgroundColor3 = Color3.fromRGB(86, 102, 85)
            ...
            TextLabel.TextColor3 = Color3.fromRGB(85, 99, 83)
            ...
            closeSection.ImageColor3 = Color3.fromRGB(88, 102, 85)
            ...
            closeSection.MouseButton1Click:Connect(function()
                if isDropped then
                    ...
                    game.TweenService:Create(closeSection, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                        Rotation = 180,
                        ImageColor3 = Color3.fromRGB(109, 145, 97)
                    }):Play()
                    game.TweenService:Create(sectionCircle, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                        BackgroundColor3 = Color3.fromRGB(109, 145, 97)
                    }):Play()
                    game.TweenService:Create(TextLabel, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                        TextColor3 = Color3.fromRGB(109, 145, 97)
                    }):Play()
                    wait(0.10)
                    UpdateSize()
                end
            ...
            function itemHandling:Button(btnText, callback)
                ...
                TextButton.BackgroundColor3 = Color3.fromRGB(109, 145, 97)
                ...
                TextButton.MouseEnter:Connect(function()
                    if callBackDebounce then
                        mouseleft = false
                        game.TweenService:Create(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),{
                            BackgroundColor3 = Color3.fromRGB(58, 84, 56)
                        }):Play()
                    else
                        mouseleft = false
                        game.TweenService:Create(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),{
                            BackgroundColor3 = Color3.fromRGB(77, 112, 74)
                        }):Play()
                    end
                end)
            ...
            function itemHandling:Toggle(togInfo, callback)
                ...
                checkBoxInfo.BackgroundColor3 = Color3.fromRGB(47, 56, 47)
                ...
                checkBoxInfo.TextColor3 = Color3.fromRGB(62, 74, 63)
                ...
                checkBox.MouseEnter:Connect(function()
                    if not tog then
                        game.TweenService:Create(checkBox, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageColor3 = Color3.fromRGB(54, 64, 54)
                        }):Play()
                    else
                        game.TweenService:Create(checkBox, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageColor3 = Color3.fromRGB(69, 105, 71)
                        }):Play()
                    end
                end)
                ...
                checkBox.MouseLeave:Connect(function()
                    if not tog then
                        ...
                        game.TweenService:Create(checkBox, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageColor3 = Color3.fromRGB(61, 74, 62)
                        }):Play()
                    else
                        checkBox.Parent:TweenSize(UDim2.new(0, 262,0, 25), "InOut", "Linear", 0.08)
                        game.TweenService:Create(checkBox, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                ...
                checkBox.MouseButton1Click:Connect(function()
                    if not clickDe then
                        ...
                        if tog then
                            ...
                            game.TweenService:Create(checkBox.Parent.checkBoxInfo, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                                TextColor3 = Color3.fromRGB(59, 71, 59)
                            }):Play()
                            checkBox.ImageRectOffset = Vector2.new(940, 784)
                            game.TweenService:Create(checkBox, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                                ImageColor3 = Color3.fromRGB(59, 71, 59)
                            }):Play()
                        end
                        wait(0.8)
                        clickDe = false
                ...
                function itemHandling:TextBox(textInfo, callback)
                    ...
                    textBoxFrame.BackgroundColor3 = Color3.fromRGB(47, 56, 47)
                    ...
                    TextBox.BackgroundColor3 = Color3.fromRGB(47, 56, 47)
                    ...
                    TextBox.Text = ""
                    TextBox.TextColor3 = Color3.fromRGB(109, 145, 97)
                ...
                function itemHandling:Slider(sliderInf, maxvalue, minvalue, callback)
                    ...
                    sliderIinfo.TextColor3 = Color3.fromRGB(109, 145, 97)
                    sliderIinfo.TextSize = 14.000
                    sliderIinfo.TextXAlignment = Enum.TextXAlignment.Left

                    sliderBtn.Name = "sliderBtn"
                    sliderBtn.Parent = sliderFrame
                    sliderBtn.BackgroundColor3 = Color3.fromRGB(47, 56, 48)
                    ...
                    SliderDrag.BackgroundColor3 = Color3.fromRGB(109, 145, 97)
                    SliderDrag.BorderColor3 = Color3.fromRGB(109, 145, 97)
                    ...
                    sliderBox.TextColor3 = Color3.fromRGB(95, 115, 96)
                ...
                function itemHandling:KeyBind(bindInfo, first, callback)
                    ...
                    keybindFrame.BackgroundColor3 = Color3.fromRGB(40, 48, 40)
                    ...
                    keybindBtn.BackgroundColor3 = Color3.fromRGB(40, 48, 40)
                    ...
                    TextLabel.TextColor3 = Color3.fromRGB(109, 145, 97)
                    TextLabel.TextSize = 14.000
                    TextLabel.TextXAlignment = Enum.TextXAlignment.Left
                ...
                function itemHandling:Dropdown(dropInfo, list, callback)
                    ...
                    dropdownFrame.BackgroundColor3 = Color3.fromRGB(49, 59, 49)
                    ...
                    dropdownFrameHeader.BackgroundColor3 = Color3.fromRGB(109, 145, 97)
                    ...
                    dropcover.BackgroundColor3 = Color3.fromRGB(109, 145, 97)
                    ...
                    dropdownCorner.Parent = dropdownFrame
                        ...
                        for i,v in next, list do
                            ...
                            optionButton.BackgroundColor3 = Color3.fromRGB(109, 145, 97)
